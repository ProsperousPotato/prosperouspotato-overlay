...
```
eselect repository add prosperouspotato-overlay git git://git.adamsucks.me/prosperouspotato-overlay.git
...
sync-type = git
sync-uri = git://git.adamsucks.me/prosperouspotato-overlay.git
EOF
emerge --sync prosperouspotato-overlay
```
